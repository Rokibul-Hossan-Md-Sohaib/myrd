...
export default class DeviceLogin extends React.Component<Props, State> {
  ...
  constructor(props: Props) {
    super(props);
    this.passRef = React.createRef();  // create a ref to store the textInput DOM element
      ...
      <View style={{ backgroundColor: '#151a30', flex: 1 }}>
        ...
        <ScrollView keyboardShouldPersistTaps="handled">
          <KeyboardAvoidingView
            ...
            />
            <Pressable onLongPress={() => this.showDateSelector()}
              style={{ height: 25, width: 25, borderRadius: 25, position: 'absolute', top: 2, right: 2, backgroundColor: '#151a30' }}>

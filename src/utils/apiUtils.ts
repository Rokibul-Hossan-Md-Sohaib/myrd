...
export const SERVER_DOMAIN = 'http://eots.kdsgroup.net:81/QmsApi';//'http://192.168.111.212:84';//'http://eots.kdsgroup.net:81/QmsApi' // http://eots.kdsgroup.net:81/QmsApi_beta'(for testing);
